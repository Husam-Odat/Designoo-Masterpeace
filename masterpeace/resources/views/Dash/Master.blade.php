    ...
    <div class="container-fluid position-relative d-flex p-0" style="background-color: white;">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar " style="background-color: white;">
                <a href="{{ url('/dash') }}" class="navbar-brand mx-4 mb-3 ">
                    <img src="{{ asset('images/logoo.png') }}" alt="" srcset="" style="width: 150px">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ url('/category') }}" class="nav-item nav-link contentmaster"><i
                            class="fas fa-table me-2"></i>Category</a>
                    <a href="{{ url('/inventory') }}" class="nav-item nav-link contentmaster"><i
                            class="fas fa-table me-2"></i>inventory</a>
                    <a href="{{ url('/discount') }}" class="nav-item nav-link contentmaster"><i
                            class="fas fa-table me-2"></i>discount</a>
                    <a href="{{ url('/orders') }}" class="nav-item nav-link contentmaster"><i
                            class="fas fa-table me-2"></i>Orders</a>
                    <a href="{{ url('/services') }}" class="nav-item nav-link contentmaster"><i
                            class="fas fa-dollar-sign me-2"></i>Products</a>
                    <a href="{{ url('/rate') }}" class="nav-item nav-link contentmaster"><i
                            class="fas fa-dollar-sign me-2"></i>Reviews</a>
                    <a href="{{ url('/contactt') }}" class="nav-item nav-link contentmaster"><i
                            class="fas fa-dollar-sign me-2"></i>Contacts</a>
                    ...
                    <a href="user" class="nav-item nav-link contentmaster"><i class="fas fa-user me-2"></i>Users</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand sticky-top px-4 py-0"
                ...
                <form class="d-none d-md-flex ms-2">
                    <input class="form-control mt-2 border-1 contentmaster searchmaster" type="search"
                        placeholder="Search">
                </form>
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end  border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <a href="{{ route('logout') }}" class="nav-item nav-link dropdown-item"
                                onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                {{ __('Log Out') }}
                            </a>
                        </div>
