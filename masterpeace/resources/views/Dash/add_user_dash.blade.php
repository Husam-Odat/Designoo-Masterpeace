            ...
            <section class="signup">
                ...
                <div class="container" style="margin:auto">
                    <div class="signup-content">
                        <form method="post" action="{{ route('user.store') }}" enctype="multipart/form-data" id="signup-form"
                            class="signup-form">
                            @csrf
                            @method('post')
                            ...
                            <div class="form-group">
                                <input type="number" class="form-input" name="role" value='{{ old('role') }}'
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-input" name="password" id="email"
