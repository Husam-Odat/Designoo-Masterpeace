                ...
                <div class="container" style="margin:auto">
                    <div class="signup-content">
                        <form method="post" action="{{ route('user.update', $data['id']) }}" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                <input type="text" value="{{ $data->email }}" class="form-input" name="email"
                                ...
                                <div class="correct-message" id="email-correct"></div>
                                <br><br>

                            </div>
                            <div class="form-group">
                                <input type="text" value="{{ $data->role }}" class="form-input" name='role'
                                ...
                                <div class="correct-message" id="role-correct"></div>
                                <br><br>
