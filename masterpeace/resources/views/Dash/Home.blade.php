            ...
            <div class="col-sm-6 col-xl-3">
                <div class=" rounded d-flex align-items-center justify-content-between p-4"
                    ...
                    <div class="ms-3">
                        ...
                        <h6 class="mb-0 text-dark">{{ $adminsCount}} </h6>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-3">
                <div class=" rounded d-flex align-items-center justify-content-between p-4"
                    ...
                    <div class="ms-3">
                        ...
                        <h6 class="mb-0 text-dark">{{ $usersCount}}</h6>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-3">
                <div class=" rounded d-flex align-items-center justify-content-between p-4"
                    ...
                    <div class="ms-3">
                        ...
                        <h6 class="mb-0 text-dark">{{ $categoriescount }}</h6>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-3">
                <div class=" rounded d-flex align-items-center justify-content-between p-4"
                    ...
                    <div class="ms-3">
                        ...
                        <h6 class="mb-0 text-dark">{{ $productscount}}</h6>
            ...
            {{-- <div class="col-sm-6 col-xl-3">
                <div class=" rounded d-flex align-items-center justify-content-between p-4"
                    ...
                    <div class="ms-3">
                        ...
                        <h6 class="mb-0 text-dark"> {{$orderscount}}</h6>
                    </div>
                </div>
            </div> --}}
        </div>
        ...
        <div class="row g-4 mt-4">
            <div class="col-sm-6 col-xl-3">
                <div class=" rounded d-flex align-items-center justify-content-between p-4"
                    ...
                    <div class="ms-3">
                        ...
                        <h6 class="mb-0 text-dark">{{ $reviewscount }}</h6>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-3">
                <div class=" rounded d-flex align-items-center justify-content-between p-4"
                    ...
                    <div class="ms-3">
                        ...
                        <h6 class="mb-0 text-dark">{{ $contactscount }}</h6>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-3">
            ...
            <div class="col-sm-6 col-xl-3">
                <div class=" rounded d-flex align-items-center justify-content-between p-4"
                    ...
                    <i class="fa fa-chart-pie fa-3x " style="color:rgb(10, 10, 105);"></i>
                    <div class="ms-3">
                        <p class="mb-2">Total Sold</p>
                        <h6 class="mb-0 text-dark">$ {{$ordersTotalSum}}</h6>
                    </div>
                </div>
            </div>
        </div>
