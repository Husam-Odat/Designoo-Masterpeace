                ...
                <div class="row">
                 ...
                 <span class="h1 fw-bold mb-0">Logo</span>
                            ...
                            <form style="width: 23rem;" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="flex items-center justify-end mt-4">
                                 ...
                                 <a href="{{ route('googlelogin') }}">
                                                <img src="{{ asset('images/google login.jpg') }}" style="width: 300px; margin-left: 60px; margin-top: 8px;" alt="photo55">
                                            </a>
                    ...
                    <div class="col-lg-6 px-0 d-none d-sm-block">
                        ...
                        {{-- class="w-100 vh-100" --}}
                            style="object-fit: cover; object-position: left; height:700px;">
                    </div>
                </div>
            </div>
        </section>
