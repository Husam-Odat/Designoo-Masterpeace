            ...
            <div class="col">
                ...
                <div class="breadcrumbs d-flex flex-row align-items-center">
                    <ul>
                        ...
                        <li class="active"><a href="{{ url('/') }}"><i class="fa fa-angle-right" aria-hidden="true"></i>Contact</a>
                        </li>
                    </ul>
                </div>
        ...
        <section class="vh-100">
            <div class="container-fluid">
                <div class="px-5 ms-xl-4">
                    ...
                    <span class="h1 fw-bold mb-0"><a href="{{ url('/contact') }}"></a></span>
                </div>
                 ...
                 <span class="h1 fw-bold mb-0">Logo</span>
                    ...
                    <div class="col-lg-6 px-0 d-none d-sm-block">
                        <img src="./images/login.png" alt="Login image" class="w-100 vh-100"
                            style="object-fit: cover; object-position: left; width:50%;">
                    </div>
                </div>
            </div>
        </section>
